#ifndef ___PLANT_CAR_H___
#define ___PLANT_CAR_H___
...
public:
    ...
    Plant_car(Eigen::MatrixXd A, Eigen::MatrixXd B1, Eigen::MatrixXd B2, Eigen::MatrixXd C, Eigen::MatrixXd D);

    Eigen::VectorXd Init(Eigen::VectorXd x0, Eigen::VectorXd u0 = Eigen::VectorXd::Zero(1));

    // 单步运行
    Eigen::VectorXd step( float dt, float w , const Eigen::VectorXd& u = Eigen::VectorXd::Zero(1));
